...
A brainless web build lives at [chud.joshuakappler.com](https://chud.joshuakappler.com): a tiny fake desktop he is loose on, flingable, no API keys, canned replies, same beatings.
